...
select
    ...
    coalesce(forward_price_21d is not NULL, FALSE) as has_1m_target,
    coalesce(forward_price_63d is not NULL, FALSE) as has_3m_target,
    coalesce(forward_price_126d is not NULL, FALSE) as has_6m_target,
    coalesce(forward_price_189d is not NULL, FALSE) as has_9m_target,
    coalesce(forward_price_252d is not NULL, FALSE) as has_12m_target
