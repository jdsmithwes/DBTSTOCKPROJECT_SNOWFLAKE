...
-- Create a dedicated admin/utility database
CREATE DATABASE ADMIN;

-- Create a security schema within it
CREATE SCHEMA ADMIN.SECURITY;

-- Store your secret there
CREATE SECRET ADMIN.SECURITY.GITHUB_PAT
    TYPE = PASSWORD
    USERNAME = 'jdsmithwes'
    PASSWORD = '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';

CREATE API INTEGRATION github_integration
    API_PROVIDER = git_https_api
    API_ALLOWED_PREFIXES = ('https://github.com/jdsmithwes/')
    ALLOWED_AUTHENTICATION_SECRETS = (ADMIN.SECURITY.GITHUB_PAT)
    ENABLED = TRUE;